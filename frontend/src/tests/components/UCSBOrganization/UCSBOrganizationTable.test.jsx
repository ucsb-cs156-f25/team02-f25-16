...
describe("UCSBOrganizationTable tests", () => {
  ...
  test("Edit button navigates to the edit page", async () => {
    ...
    await waitFor(() =>
      expect(mockedNavigate).toHaveBeenCalledWith("/ucsborganizations/edit/FCSB"),
    );
  });
  ...
  test("Delete button calls delete callback", async () => {
    ...
    axiosMock
      ...
      .reply(200, { message: "UCSBOrganization with id FCSB deleted" });
    ...
    expect(axiosMock.history.delete[0].params).toEqual({ orgCode: "FCSB" });
  });
});
