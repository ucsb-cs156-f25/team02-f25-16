...
describe("RecommendationRequestForm tests", () => {
  ...
  // Fractional seconds aren't asserted because html input type="datetime-local" in jsdom
  // doesn't consistently accept them; regex mutants are disabled in the component instead.
