...
public class HelpRequestWebIT extends WebTestCase {
  ...
  public void admin_user_can_create_edit_delete_helpRequest() throws Exception {
    ...
    page.getByLabel("Requester Email").fill("email@example.com");
    page.getByLabel("Team ID").fill("27");
    page.getByLabel("Table or Breakout Room").fill("Table 1");
    page.getByLabel("Explanation").fill("This is a help request");
    page.getByLabel("Request Time").fill("2024-01-01T12:00");
    ...
    assertThat(page.getByTestId("HelpRequestTable-cell-row-0-col-explanation"))
        .hasText("This is a help request");
