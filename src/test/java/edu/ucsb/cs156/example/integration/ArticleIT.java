...
public class ArticleIT {
  ...
  public void test_that_logged_in_user_can_get_by_id_when_the_id_exists() throws Exception {
    ...
    Articles article =
        Articles.builder()
            ...
            .dateAdded(LocalDateTime.parse("2025-11-06T12:00:00"))
            .build();
  ...
  public void an_admin_user_can_post_a_new_article() throws Exception {
    ...
    LocalDateTime dateAdded = LocalDateTime.parse("2025-11-06T12:00:00");
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/articles/post?title=Article Title"
                        + "&url=https://example.com/article"
                        + "&explanation=Explanation of the article"
                        + "&submitterEmail=m_srivastava@ucsb.edu"
                        + "&dateAdded=2025-11-06T12:00:00")
                    .with(csrf()))
