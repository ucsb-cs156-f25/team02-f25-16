...
|---------------------------|--------------|------------|
| UCSBDiningCommonsMenuItem | Alex J.      | alexjh2    |
| UCSBOrganization          | Quinn K.     | quinnkos   |
| RecommendationRequest     | Saqif A.     | Saqif-Ayaan|
| MenuItemReview            | William L.   | wpleee     |
| HelpRequest               | Omar A.      | omar882    |
| Articles                  | Mihir S.     | mihir-s-05 |
